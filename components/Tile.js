...
const TONES = {
  school: 'bg-[#E8F0FE] text-[#2B5CA8]',
  radext: 'bg-[#E9F3EC] text-[#2F6F4E]',
  runehaven: 'bg-[#F3ECFB] text-[#6B44A8]',
  leadlens: 'bg-[#EEF6E4] text-[#4F7A20]',
  ambient: 'bg-[#FDF0E4] text-[#B4761F]',
  routine: 'bg-[#F0EFEC] text-[#6E6B66]',
  general: 'bg-[#F0EFEC] text-[#6E6B66]',
};
